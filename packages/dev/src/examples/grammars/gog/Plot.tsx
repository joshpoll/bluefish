...
export const Plot: React.FC<PropsWithChildren<PlotProps>> = forwardRef(
  (props, ref) => {
    ...
    return (
      <Group ref={ref}>
        <PlotContext.Provider
          value={{ dimensions, scales: renamedScales, data }}
        >
...
export const Plot2 = withBluefishFn(
  ...
  (props: PropsWithChildren<PlotProps> & { $bbox?: Partial<NewBBox> }) => {
    ...
    return (
      <Group>
        <PlotContext.Provider
          value={{ dimensions: oldDimensions, scales: renamedScales, data }}
        >
          <Group>{children}</Group>
        </PlotContext.Provider>
      </Group>
