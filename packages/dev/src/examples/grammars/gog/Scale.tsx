  ...
  (measurables, constraints) => {
    const placeables = measurables.map((measurable, idx) => {
      ...
      const xScale = props.xScale
        ? props.xScale({ width: width!, height: height! })
        : (x: number) => x;
      const yScale = props.yScale
        ? props.yScale({ width: width!, height: height! })
        : (y: number) => y;
      ...
      if (placeable.left !== undefined) {
        placeable.left =
          props.left !== false ? xScale(placeable.left) : placeable.left;
      } else {
        placeable.left = 0;
      }
      if (placeable.top !== undefined) {
        placeable.top =
          props.top !== false ? yScale(placeable.top) : placeable.top;
      } else {
        placeable.top = 0;
      }
      ...
      console.log(
        "placeable height",
        placeable.height,
        yScale ? yScale(placeable.height) : undefined
      );
      ...
      if (
        placeable.right !== undefined &&
        (placeable.left !== undefined || placeable.width !== undefined)
      ) {
        placeable.right =
          props.right !== false ? xScale(placeable.right) : placeable.right;
      }
      if (
        placeable.bottom !== undefined &&
        (placeable.top !== undefined || placeable.height !== undefined)
      ) {
        placeable.bottom =
          props.bottom !== false ? yScale(placeable.bottom) : placeable.bottom;
      }
