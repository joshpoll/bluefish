...
export const order = [18, 17, 19, 7, 10, 3, 11, 12, 15, 13, 0, 1, 6, 8, 9, 16, 5, 2, 4, 14];
...
// permute positioning to match order
export const positioningOrdered = order.map((i) => positioning[i]);
