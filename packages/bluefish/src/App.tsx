...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/* 175 tuple length object */}
      {/* Times in ms: 489.10, 474.66, 492.66, 491.39, 497.20*/}
      {/* <SVG width={800} height={400}>
        <PythonTutor
          variables={[variable('c', pointer(0)), variable('d', pointer(1)), variable('x', 5)]}
          objects={[
            ...
            tuple([41, 75, 97, 89, 25, 44, 90, 34]),
            tuple([
              41, 65, 64, 83, 52, 73, 54, 50, 70, 74, 98, 81, 17, 89, 68, 70, 85, 76, 28, 47, 57, 34, 40, 98, 7, 61, 19,
              83, 43, 48, 99, 13, 69, 30, 90, 66, 47, 19, 96, 78, 92, 99, 8, 46, 82, 84, 17, 31, 73, 80, 40, 39, 46, 10,
              1, 12, 33, 99, 72, 68, 59, 57, 37, 90, 76, 61, 58, 90, 92, 24, 68, 26, 29, 14, 11, 41, 74, 25, 5, 89, 49,
              44, 2, 47, 60, 67, 65, 18, 74, 42, 4, 73, 73, 3, 28, 69, 84, 98, 26, 35, 72, 50, 47, 97, 65, 85, 36, 6,
              94, 7, 30, 31, 93, 58, 31, 35, 86, 45, 79, 9, 37, 29, 9, 29, 35, 18, 38, 12, 73, 68, 63, 80, 77, 6, 22,
              24, 30, 96, 33, 83, 56, 89, 39, 72, 99, 46, 8, 56, 76, 44, 20, 18, 45, 82, 4, 42, 67, 19, 19, 7, 41, 67,
              27, 61, 63, 12, 57, 91, 61, 45, 35, 42, 13, 61, 81,
            ]),
          ]}
          rows={[
            [0, null, null],
      ...
      {/* 375 tuple length object */}
      {/* Times in ms: 823.78, 776.55, 776.83, 757.25, 782.66 */}
      {/* <SVG width={800} height={400}>
        <PythonTutor
          variables={[variable('c', pointer(0)), variable('d', pointer(1)), variable('x', 5)]}
          objects={[
            ...
            tuple([41, 75, 97, 89, 25, 44, 90, 34]),
            tuple([
              75, 46, 9, 89, 25, 77, 80, 38, 66, 4, 23, 27, 82, 42, 63, 22, 28, 99, 79, 1, 78, 66, 89, 99, 62, 89, 32,
              66, 23, 75, 33, 62, 49, 90, 49, 73, 65, 59, 90, 55, 74, 24, 38, 71, 40, 13, 58, 16, 78, 35, 13, 49, 87,
              18, 82, 6, 88, 77, 50, 34, 23, 89, 92, 65, 29, 73, 92, 66, 44, 68, 65, 45, 54, 38, 17, 59, 55, 30, 22, 75,
              38, 78, 30, 68, 98, 62, 55, 21, 43, 23, 19, 64, 53, 84, 42, 26, 60, 70, 88, 92, 31, 31, 96, 73, 79, 97,
              49, 99, 95, 94, 89, 63, 2, 17, 2, 17, 4, 22, 94, 85, 44, 9, 42, 66, 0, 0, 1, 60, 93, 31, 45, 12, 28, 4,
              56, 41, 94, 42, 94, 30, 73, 96, 56, 97, 6, 79, 57, 30, 10, 70, 49, 57, 44, 39, 41, 29, 96, 93, 82, 4, 3,
              55, 33, 91, 56, 22, 91, 22, 78, 78, 28, 81, 4, 28, 25, 47, 66, 98, 20, 98, 3, 84, 98, 22, 44, 81, 33, 98,
              47, 80, 32, 79, 55, 82, 62, 22, 35, 49, 28, 87, 15, 16, 25, 74, 66, 80, 50, 89, 95, 82, 13, 25, 9, 65, 60,
              12, 0, 63, 26, 1, 22, 10, 18, 46, 42, 62, 96, 46, 42, 18, 0, 19, 53, 67, 52, 21, 45, 19, 61, 70, 30, 40,
              4, 32, 45, 30, 12, 60, 27, 94, 42, 32, 40, 77, 71, 55, 75, 6, 84, 50, 49, 39, 5, 71, 38, 87, 77, 45, 12,
              94, 79, 86, 63, 66, 49, 45, 69, 20, 67, 18, 11, 82, 57, 32, 56, 42, 9, 13, 33, 59, 81, 37, 74, 57, 4, 20,
              79, 47, 32, 6, 33, 77, 30, 47, 54, 40, 78, 93, 11, 48, 29, 91, 81, 36, 86, 87, 33, 24, 22, 72, 6, 28, 61,
              12, 24, 7, 42, 15, 26, 3, 53, 6, 90, 0, 39, 39, 4, 67, 93, 88, 70, 10, 77, 85, 30, 0, 25, 73, 98, 17, 35,
              11, 28, 24, 14, 40, 45, 74, 96, 79, 68, 72, 55, 86, 4, 57, 31, 72, 46, 83, 4, 92, 60, 44, 87,
            ]),
          ]}
          rows={[
            [0, null, null],
      ...
      {/* 625 tuple length object */}
      {/* Times: 1.02s, 1.01s, 965.89ms, 905.49ms, 1.18s */}
      {/* <SVG width={800} height={400}>
        <PythonTutor
          variables={[variable('c', pointer(0)), variable('d', pointer(1)), variable('x', 5)]}
          objects={[
            ...
            tuple([41, 75, 97, 89, 25, 44, 90, 34]),
            tuple([
              44, 98, 67, 26, 0, 77, 92, 70, 52, 6, 37, 97, 15, 40, 92, 54, 46, 14, 11, 22, 5, 52, 68, 95, 30, 52, 67,
              38, 35, 75, 32, 63, 97, 75, 98, 35, 57, 43, 61, 95, 79, 2, 18, 44, 92, 6, 3, 63, 36, 16, 59, 76, 57, 27,
              28, 52, 60, 96, 95, 16, 53, 99, 23, 66, 21, 38, 92, 3, 93, 97, 29, 8, 1, 65, 99, 84, 41, 26, 25, 18, 14,
              57, 48, 58, 78, 73, 45, 40, 1, 66, 90, 75, 38, 79, 0, 25, 91, 18, 89, 14, 95, 44, 57, 21, 98, 38, 56, 63,
              70, 2, 47, 85, 57, 21, 9, 55, 41, 86, 82, 65, 68, 84, 21, 73, 41, 43, 75, 59, 71, 94, 17, 22, 81, 76, 91,
              1, 58, 16, 0, 2, 3, 29, 55, 28, 4, 80, 55, 8, 77, 27, 21, 33, 7, 54, 3, 49, 84, 64, 7, 93, 38, 34, 46, 60,
