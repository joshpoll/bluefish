    ...
    setTimeout(() => {
      ...
      allRefsTo.forEach((refTo) => {
        ...
        if (domObject) {
          ...
          const squareChild = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
          squareChild.setAttribute('x', '0');
          squareChild.setAttribute('y', '0');
          squareChild.setAttribute('width', '100');
          squareChild.setAttribute('height', '100');
          squareChild.setAttribute('aria-label', `square`);
          (domObject as any).appendChild(squareChild);
        }
